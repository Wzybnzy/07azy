<template>
  <div class="index">
    <div class="index-header">
      <span>语雀</span>
      <span class="sp"><el-input v-model="input" placeholder="请输入内容"></el-input><i class="el-icon-search" @click="todetail"></i></span>
      <span>
...
export default {
  ...
  methods: {
     ...
     handleEdit(index, row) {
         ...
         localStorage.isshow=row.isshow
     },

    async todetail(){
      let {input}=this
       
       this.$router.push({path:"/index/search",query:{input}})
     }
  },
 async created() {
